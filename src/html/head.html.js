...
GSUI.setTemplate( "head", () => (
	GSUI.createElement( "div", { id: "head" },
		...
		GSUI.createElement( "div", { id: "winBtns" },
			GSUI.createElement( "button", { class: "btn btnMarge winBtn", "data-win": "blocks", title: "Open/close the blocks window" }, "blocks" ),
			GSUI.createElement( "button", { class: "btn btnMarge winBtn", "data-win": "mixer", title: "Open/close the mixer window" }, "mixer" ),
			GSUI.createElement( "button", { class: "btn btnMarge winBtn", "data-win": "synth", title: "Open/close the synthesizer window" }, "synth" ),
			GSUI.createElement( "button", { class: "btn btnMarge winBtn", "data-win": "main", title: "Open/close the composition window" }, "composition" ),
			GSUI.createElement( "button", { class: "btn btnMarge winBtn", "data-win": "drums", title: "Open/close the drums window" }, "drums" ),
			GSUI.createElement( "button", { class: "btn btnMarge winBtn", "data-win": "piano", title: "Open/close the piano window" }, "pianoroll" ),
			GSUI.createElement( "button", { class: "btn btnMarge winBtn", "data-win": "effects", title: "Open/close the effects window" }, "effects" ),
		),
		GSUI.createElement( "div", { id: "headHelp" },
			...
			GSUI.createElement( "button", { class: "btn btnMarge btnLarge btnBg gsuiIcon", id: "helpKeyboardShortcuts", "data-icon": "keyboard", title: "Keyboard shortcuts" } ),
