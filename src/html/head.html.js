...
GSUI.setTemplate( "head", () => (
	GSUI.createElement( "div", { id: "head" },
		...
		GSUI.createElement( "div", { id: "winBtns" },
			...
			GSUI.createElement( "button", { class: "btn btnMarge winBtn gsuiIcon", "data-icon": "music", "data-win": "synth", title: "Open/close the synthesizer window" } ),
			GSUI.createElement( "button", { class: "btn btnMarge winBtn gsuiIcon", "data-icon": "oscillator", "data-win": "main", title: "Open/close the composition window" } ),
			GSUI.createElement( "button", { class: "btn btnMarge winBtn gsuiIcon", "data-icon": "keys", "data-win": "drums", title: "Open/close the drums window" } ),
			GSUI.createElement( "button", { class: "btn btnMarge winBtn gsuiIcon", "data-icon": "drums", "data-win": "piano", title: "Open/close the piano window" } ),
